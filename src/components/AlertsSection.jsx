...
const cards = [
  {
    ...
    actions: (
      <>
        <button className="px-[7px] py-2 hover:bg-gray-100">View on Map</button>
        <div className="w-px bg-gray-300" />
        <button className="px-4 py-2 hover:bg-gray-100">Acknowledge</button>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <div className="mt-4">
          <p className="text-[9px]">Total biomass: <br /><strong className="text-[16px]">620 tons</strong></p>
          <p className="text-[9px] mt-1">Unassigned Parcels:<br /><strong className="text-[16px]">#98, #106, #110</strong></p>
        </div>
      </>
    ),
    actions: (
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <div className="mt-4">
          <p className="text-[9px]">Consecutive dip:<br /><strong className="text-[16px]">3 Day</strong></p>
          <div className="flex mt-2 space-x-4">
            <p className="text-[9px]">Forecasted:<br /><strong className="text-[16px]">1080 <span className="text-[8px]">tons</span></strong></p>
            <p className="text-[9px]">Collected:<br /><strong className="text-[16px]">620 <span className="text-[8px]">tons</span></strong></p>
          </div>
        </div>
      </>
    ),
          ...
          <CardContent className="flex flex-col justify-between h-full p-4">
            ...
            <div>
              <div className="flex items-start gap-2">
                ...
                <div>
                  <h4 className="text-[14px] font-semibold" style={{ color: card.titleColor }}>{card.title}</h4>
