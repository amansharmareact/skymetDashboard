...
const ParcelEstimateCard = () => {
  return (
    <div className="flex justify-between items-center border border-[#ECECED] rounded-2xl px-2 mt-[16px] w-[540px] h-[80px] text-[#717680] text-[16px] font-medium gap-[16px]">
      <div>
        <p>Fields Selected:</p>
