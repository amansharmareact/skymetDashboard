...
const CropReadinessCard = () => {
  return (
    <div className="w-full p-0 mt-4 flex flex-wrap mt-[16px]">
      <div className="text-[#717680] font-bold text-[14px] ml-2 mb-2 w-full">
        Crop + Harvest Summary :
      </div>

      <div className="w-full grid-col-1 gap-4 lg:max-w-5xl grid grid-cols-4">
        {/* Crop + Harvest Summary */}
        <div className="w-full h-auto p-4 border border-[#ECECED] rounded-xl space-y-2 col-span-2">
        ...
        {/* Readiness Score */}
        <div className="w-full flex flex-col items-center justify-between rounded-xl border border-[#ECECED] px-4 py-6 col-span-2">
