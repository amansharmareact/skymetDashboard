            ...
            <div className="flex items-center gap-[24px]">
              ...
              <div className="inline-flex border border-gray-300 rounded-lg overflow-hidden text-sm font-medium">
                <button
                  ...
                  className=" py-[10px] px-[16px] text-sm font-semibold text-[#414651] bg-white focus:outline-none focus:ring-0"
                >
                  Reassign
                </button>
                <button
                  className=" py-[10px] px-[16px] text-sm font-semibold text-[#414651] bg-white border-l focus:outline-none focus:ring-0"
                >
                  Split Parcels
                </button>
                <button
